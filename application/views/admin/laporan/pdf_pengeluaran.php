                    ...
                    <tbody>
                        ...
                        foreach ($pengeluaran as $item) : ?>
                            <tr>
                                ...
                                <td><?php $total += $item->hargaSatuan * $item->qty ?>Rp.<?php echo number_format($item->hargaSatuan * $item->qty, 2, ',', '.'); ?></td>
                            </tr>
                        <?php endforeach ?>
                        <tr>
                            <th colspan="6" class="text-right pr-4 bg-dark text-white">Total Pengeluaran</th>
