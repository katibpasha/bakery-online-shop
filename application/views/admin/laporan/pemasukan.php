...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Manajemen Laporan Pemasukan</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="#">Laporan Pemasukan</a></div>
                <div class="breadcrumb-item">Main</div>
            </div>
        </div>
        <div class="section-body">
            <h2 class="section-title">Data Laporan Pemasukan</h2>
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h4>Data Laporan Pemasukan</h4>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo site_url('Laporan/cetakLaporanPemasukan') ?>" method="POST" target="_BLANK">
                                <div class="row">
                                    <div class="col-md-6">
