                          ...
                          <form action="<?php echo site_url('kategori/edit') ?>" method="POST">
                              <div class="card">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <input type="hidden" class="form-control" id="inputEmail3" name="idKat" value="<?= $kategori->idKat ?>">
                                      <div class="form-group row">
                                          <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Kategori</label>
                                          <div class="col-sm-7">
                                              <input type="text" class="form-control" id="inputEmail3" name="namaKategori" placeholder="Nama Kategori" value="<?= $kategori->namaKat ?>">
                                          </div>
                                      </div>
                                  </div>
