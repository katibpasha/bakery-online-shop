              ...
              <div class="section-body">
                  ...
                  <div class="row">
                      <div class="col-12 col-md-6 col-lg-6">
                          <form action="<?php echo site_url('Ongkir/edit') ?>" method="POST">
                              <div class="card">
                                  <div class="card-header">
                                      <h4>Form Tambah Ongkir</h4>
                                  </div>
                                  <div class="card-body">
                                      <input type="hidden" name="idOngkir" value="<?php echo $ongkir->idBiayaKirim ?>">
                                      <div class="form-group row">
                                          <label for="inputEmail3" class="col-sm-2 col-form-label">Agen Kurir</label>
                                          <div class="col-sm-7">
                                              <select class="form-control selectric" name="kurir">
                                                  <option value="<?php echo $ongkir->idKurir ?>"><?php echo $ongkir->idKurir ?></option>
                                      ...
                                      <div class="form-group row">
                                          ...
                                          <div class="col-sm-7">
                                              <select class="form-control selectric" name="kota">
                                                  <option value="<?php echo $ongkir->idKotaTujuan ?>"><?php echo $ongkir->idKotaTujuan ?></option>
                                      ...
                                      <div class="form-group row">
                                          ...
                                          <div class="col-sm-7">
                                              <input type="number" class="form-control" id="inputEmail3" name="biaya" placeholder="Biaya" required value="<?php echo $ongkir->biaya ?>">
                                          </div>
                                      </div>
                                  </div>
