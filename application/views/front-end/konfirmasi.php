                    ...
                    <div class="breadcrumb__wrap">
                        <ul class="breadcrumb__list">
                            ...
                            <li class="is-marked">
                                ...
                                <a href="<?php echo site_url('Checkout/konfirmasi') ?>">My Account</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                <div class="dash__pad-2">
                                    <h1 class="dash__h1 u-s-m-b-14">Konfirmasi Pembayaran</h1>

                                    <span class="dash__text u-s-m-b-30">Silahkan Upload Bukti Pendaftaran</span>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="dash-edit-p" method="POST" action="<?= site_url('Konfirmasi/action_konfirmasi') ?>" enctype="multipart/form-data">
                                                <div class="gl-inline">
                                                    <div class="u-s-m-b-30">
                                                        <input type="hidden" name="id" value="<?= $invoice ?>">
                                                        <label class="gl-label" for="reg-fname">Upload Bukti Pembayaran Disini Berupa JPG/PNG*</label>
                                                        <input class="input-text input-text--primary-style" type="file" id="reg-fname" placeholder="Bukti Bayar" style="padding: 10px 0 0 10px;" name="bayar" accept="image/*">
                                                    </div>
                                                </div>
