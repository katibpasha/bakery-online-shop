                    ...
                    <div class="col-lg-6 col-md-8 u-s-m-b-30">
                        <div class="l-f-o">
                            <div class="l-f-o__pad-box">
                                ...
                                <form class="l-f-o__form" method="POST" action="<?= site_url('Home/action_forgot') ?>">
                                    <div class="u-s-m-b-30">

                                        <label class="gl-label" for="reset-email">E-MAIL *</label>

                                        <input class="input-text input-text--primary-style" type="text" id="reset-email" placeholder="Enter E-mail" name="email">
                                    </div>
                                    <div class="u-s-m-b-30">
                                    ...
                                    <div class="u-s-m-b-30">
                                        ...
                                        <a class="gl-link" href="<?= site_url('Home/signin') ?>">Back to Login</a>
                                    </div>
                                </form>
                            </div>
                        </div>
