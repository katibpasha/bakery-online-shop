                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                <div class="dash__pad-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="dash-edit-p" method="POST" action="<?= site_url('Member/action_edit/' . 'email') ?>">
                                                <div class="gl-inline">
                                                    <div class="u-s-m-b-30">

                                                        <label class="gl-label" for="reg-fname">Email *</label>
                                                        <small>Pastikan masukan email yang berbeda</small>
                                                        <input type="hidden" name="id" value="<?= $member->idMember ?>">
                                                        <input class="input-text input-text--primary-style" type="text" id="reg-fname" placeholder="Email" name="email" value="<?= $member->email ?>">
