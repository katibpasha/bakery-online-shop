                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                <div class="dash__pad-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="dash-edit-p" method="POST" action="<?= site_url('Member/action_edit/' . 'profile') ?>">
                                                <div class="gl-inline">
                                                    <div class="u-s-m-b-30">

                                                        <label class="gl-label" for="reg-fname">NAMA LENGKAP *</label>
                                                        <input type="hidden" name="id" value="<?= $member->idMember ?>">
                                                        <input class="input-text input-text--primary-style" type="text" id="reg-fname" placeholder="Nama Lengkap" name="nama" value="<?= $member->namaKonsumen ?>">
                                                    ...
                                                    <div class="u-s-m-b-30">
                                                        ...
                                                        <input class="input-text input-text--primary-style" type="text" id="reg-lname" placeholder="No HP" name="telpon" value="<?= $member->telpon ?>">
                                                        <?= form_error('telpon', '<small class="text-danger" style="color: red;">', '</small>') ?>
                                                    </div>
                                                    <div class="u-s-m-b-30">

                                                        <label class="gl-label" for="reg-lname">ALAMAT *</label>

                                                        <input class="input-text input-text--primary-style" type="text" id="reg-lname" placeholder="Alamat" name="alamat" value="<?= $member->alamat ?>">
